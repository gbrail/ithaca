...
function isStackOverflowError(err) {
  return false;
  // RHINO MODIFICATION: We can't intercept a stack trace like this.
  // For this to work, we'd have to keep track of our own stack and throw a
  // RhinoException on overflow, not a Java Error
  /*
