...
module.exports = function () {
  ...
  ErrorPrototype,
  // 20.5
  AggregateErrorPrototype, EvalErrorPrototype, RangeErrorPrototype, ReferenceErrorPrototype, SyntaxErrorPrototype, TypeErrorPrototype, URIErrorPrototype,
  ...
  TypedArrayPrototype,
  // 23.2
  Int8ArrayPrototype, Uint8ArrayPrototype, Uint8ClampedArrayPrototype, Int16ArrayPrototype, Uint16ArrayPrototype, Int32ArrayPrototype, Uint32ArrayPrototype, Float32ArrayPrototype, Float64ArrayPrototype, BigInt64ArrayPrototype, BigUint64ArrayPrototype,
  // 24 Keyed Collections
  MapPrototype,
  // 24.1
  // 24.1.5 MapIteratorPrototype
  ObjectGetPrototypeOf(new Map()[SymbolIterator]()), SetPrototype,
  // 24.2
  // 24.2.5 SetIteratorPrototype
  ObjectGetPrototypeOf(new Set()[SymbolIterator]()), WeakMapPrototype,
  // 24.3
  WeakSetPrototype,
  // 24.4
  ...
  // 24.1
  // 24.1.5 MapIteratorPrototype
  ObjectGetPrototypeOf(new Map()[SymbolIterator]()), Set,
  // 24.2
  // 24.2.5 SetIteratorPrototype
  ObjectGetPrototypeOf(new Set()[SymbolIterator]()), WeakMap,
  // 24.3
  WeakSet,
  // 24.4
  ...
  // 27.1.2 IteratorPrototype
  // 27.1.3 AsyncIteratorPrototype
  ObjectGetPrototypeOf(ObjectGetPrototypeOf(ObjectGetPrototypeOf(function () {
  ...
  escape, unescape,
  // Other APIs / Web Compatibility
  clearImmediate, clearInterval, clearTimeout, setImmediate, setInterval, setTimeout, console];
  ...
  if (typeof WebAssembly !== 'undefined') {
    ArrayPrototypePush(intrinsicPrototypes, WebAssembly.Module.prototype, WebAssembly.Instance.prototype, WebAssembly.Table.prototype, WebAssembly.Memory.prototype, WebAssembly.CompileError.prototype, WebAssembly.LinkError.prototype, WebAssembly.RuntimeError.prototype);
  ...
  if (typeof Temporal !== 'undefined') {
    ArrayPrototypePush(intrinsicPrototypes, Temporal.Duration.prototype, Temporal.Instant.prototype, Temporal.PlainDate.prototype, Temporal.PlainDateTime.prototype, Temporal.PlainMonthDay.prototype, Temporal.PlainTime.prototype, Temporal.PlainYearMonth.prototype, Temporal.ZonedDateTime.prototype);
    ArrayPrototypePush(intrinsics, Temporal);
  }
  ArrayPrototypeForEach(intrinsicPrototypes, enableDerivedOverrides);
  var frozenSet = new WeakSet();
  ...
  function deepFreeze(root) {
    ...
    function innerDeepFreeze(node) {
      ...
      function doFreeze(obj) {
        ...
        var descs = ObjectGetOwnPropertyDescriptors(obj);
        enqueue(proto);
