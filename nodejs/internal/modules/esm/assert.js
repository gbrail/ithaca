...
var kImplicitTypeAttribute = 'javascript';
 ...
 */
var supportedTypeAttributes = ArrayPrototypeFilter(ObjectValues(formatTypeMap), type => type !== kImplicitTypeAttribute);
...
function validateAttributes(url, format) {
  ...
  var validType = formatTypeMap[format];
  switch (validType) {
    case undefined:
