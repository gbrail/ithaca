...
var kBeforeEvent = CHAR_LOWERCASE_B;
var kEndEvent = CHAR_LOWERCASE_E;
var kTraceEventCategory = 'node,node.async_hooks';
var kEnabled = Symbol('enabled');
...
var nativeProviders = new SafeSet(ObjectKeys(async_wrap.Providers));
var typeMemory = new SafeMap();
