...
var kOnConstructed = Symbol('kOnConstructed');
var kIsClosedPromise = SymbolFor('nodejs.webstream.isClosedPromise');
var kControllerErrorFunction = SymbolFor('nodejs.webstream.controllerErrorFunction');
var kState = Symbol('kState');
var kObjectMode = 1 << 0;
var kErrorEmitted = 1 << 1;
var kAutoDestroy = 1 << 2;
var kEmitClose = 1 << 3;
var kDestroyed = 1 << 4;
var kClosed = 1 << 5;
var kCloseEmitted = 1 << 6;
var kErrored = 1 << 7;
var kConstructed = 1 << 8;
function isReadableNodeStream(obj) {
  var strict = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  return !!(obj && typeof obj.pipe === 'function' && typeof obj.on === 'function' && (!strict || typeof obj.pause === 'function' && typeof obj.resume === 'function') && (!obj._writableState || obj._readableState?.readable !== false) && (
  // Duplex
  !obj._writableState || obj._readableState) // Writable has .pipe.
  );
}
function isWritableNodeStream(obj) {
  return !!(obj && typeof obj.write === 'function' && typeof obj.on === 'function' && (!obj._readableState || obj._writableState?.writable !== false) // Duplex
  );
}
