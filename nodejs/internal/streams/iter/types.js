 ...
 */
var toStreamable = SymbolFor('Stream.toStreamable');
 ...
 */
var broadcastProtocol = SymbolFor('Stream.broadcastProtocol');

/**
 * Symbol for Shareable protocol - object can provide a Share.
 */
var shareProtocol = SymbolFor('Stream.shareProtocol');

/**
 * Symbol for SyncShareable protocol - object can provide a SyncShare.
 */
var shareSyncProtocol = SymbolFor('Stream.shareSyncProtocol');
 ...
 */
var drainableProtocol = SymbolFor('Stream.drainableProtocol');
 ...
 */
var kValidatedTransform = Symbol('kValidatedTransform');
 ...
 */
var kSyncWriteAcceptedOnFalse = Symbol('kSyncWriteAcceptedOnFalse');
module.exports = {
  broadcastProtocol,
  drainableProtocol,
  kSyncWriteAccepted,
