 ...
 */
function onClientStreamCreated(_ref) {
  var {
    stream,
    headers
  } = _ref;
 ...
 */
function onClientStreamError(_ref2) {
  var {
    stream,
    error
  } = _ref2;
 ...
 * }} event
 */
function onClientStreamBodyChunkSent(_ref3) {
  var {
    stream,
    writev,
    data,
 ...
 */
function onClientStreamBodySent(_ref4) {
  var {
    stream
  } = _ref4;
  if (typeof stream[kInspectorRequestId] !== 'string') {
 ...
 * @param {{ stream: import('http2').ClientHttp2Stream, headers: object }} event
 */
function onClientStreamFinish(_ref5) {
  var {
    stream,
    headers
  } = _ref5;
 ...
 * @param {{ stream: import('http2').ClientHttp2Stream }} event
 */
function onClientStreamClose(_ref6) {
  var {
    stream
  } = _ref6;
  if (typeof stream[kInspectorRequestId] !== 'string') {
...
module.exports = registerDiagnosticChannels([['http2.client.stream.created', onClientStreamCreated], ['http2.client.stream.error', onClientStreamError], ['http2.client.stream.finish', onClientStreamFinish], ['http2.client.stream.close', onClientStreamClose], ['http2.client.stream.bodyChunkSent', onClientStreamBodyChunkSent], ['http2.client.stream.bodySent', onClientStreamBodySent]]);
