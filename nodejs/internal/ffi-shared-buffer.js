...
var sI8 = DataViewPrototypeSetInt8;
var gI8 = DataViewPrototypeGetInt8;
var sU8 = DataViewPrototypeSetUint8;
var gU8 = DataViewPrototypeGetUint8;
var sI16 = DataViewPrototypeSetInt16;
var gI16 = DataViewPrototypeGetInt16;
var sU16 = DataViewPrototypeSetUint16;
var gU16 = DataViewPrototypeGetUint16;
var sI32 = DataViewPrototypeSetInt32;
var gI32 = DataViewPrototypeGetInt32;
var sU32 = DataViewPrototypeSetUint32;
var gU32 = DataViewPrototypeGetUint32;
var sI64 = DataViewPrototypeSetBigInt64;
var gI64 = DataViewPrototypeGetBigInt64;
var sU64 = DataViewPrototypeSetBigUint64;
var gU64 = DataViewPrototypeGetBigUint64;
var sF32 = DataViewPrototypeSetFloat32;
var gF32 = DataViewPrototypeGetFloat32;
var sF64 = DataViewPrototypeSetFloat64;
var gF64 = DataViewPrototypeGetFloat64;
var sbTypeInfo = {
  __proto__: null,
  i8: {
    set: sI8,
...
function writeNumericArg(view, info, offset, arg, index) {
  var kind = info.kind;
  if (kind === 'int') {
    if (typeof arg !== 'number' || !NumberIsInteger(arg) || arg < info.min || arg > info.max) {
...
function wrapWithSharedBuffer(rawFn, signature) {
  ...
  var buffer = rawFn[kSbSharedBuffer];
  ...
  if (signature === undefined) {
    ...
    assert(argumentTypes !== undefined && returnType !== undefined, 'FFI: shared-buffer raw function is missing kSbArguments or kSbReturn');
  } else {
    argumentTypes = signature.arguments ?? [];
    returnType = signature.return ?? 'void';
  }
  var slowInvoke = rawFn[kSbInvokeSlow];
  var view = new DataView(buffer);
  var retGetter = null;
  if (returnType !== 'void') {
    var retInfo = sbTypeInfo[returnType];
    assert(retInfo !== undefined, `FFI: shared-buffer type table missing entry for return type "${returnType}"`);
    retGetter = retInfo.get;
  }
  var nargs = argumentTypes.length;
  var argInfos = [];
  var argOffsets = [];
  var anyPointer = false;
  for (var i = 0; i < nargs; i++) {
    var info = sbTypeInfo[argumentTypes[i]];
    assert(info !== undefined, `FFI: shared-buffer type table missing entry for argument type "${argumentTypes[i]}"`);
  ...
  if (anyPointer) {
    ...
    assert(slowInvoke !== undefined, 'FFI: shared-buffer raw function with pointer arguments is missing kSbInvokeSlow');
    wrapper = function () {
      ...
      for (var _i = 0; _i < nargs; _i++) {
        var _info = argInfos[_i];
        var offset = argOffsets[_i];
        if (_info.kind === 'pointer') {
          if (!writePointerArg(view, offset, args[_i], _i)) {
            return ReflectApply(slowInvoke, undefined, args);
          }
        } else {
          writeNumericArg(view, _info, offset, args[_i], _i);
        }
      }
      rawFn();
    ...
    // `retGetter`.
    wrapper = buildNumericWrapper(rawFn, view, argInfos, argOffsets, nargs, retGetter);
  }
...
function buildNumericWrapper(rawFn, view, argInfos, argOffsets, nargs, retGetter) {
  ...
  if (nargs === 2) {
    ...
    if (retGetter === null) {
      return function (a0, a1) {
        ...
        writeNumericArg(view, _i2, _o, a0, 0);
  ...
  if (nargs === 3) {
    ...
    var _i4 = argInfos[1];
    var i2 = argInfos[2];
    var _o2 = argOffsets[0];
    var _o3 = argOffsets[1];
    var o2 = argOffsets[2];
    if (retGetter === null) {
      return function (a0, a1, a2) {
        ...
        writeNumericArg(view, _i3, _o2, a0, 0);
        writeNumericArg(view, _i4, _o3, a1, 1);
  ...
  if (nargs === 4) {
    ...
    var _i7 = argInfos[2];
    var i3 = argInfos[3];
    var _o4 = argOffsets[0];
    var _o5 = argOffsets[1];
    var _o6 = argOffsets[2];
    var o3 = argOffsets[3];
    if (retGetter === null) {
      return function (a0, a1, a2, a3) {
        ...
        writeNumericArg(view, _i5, _o4, a0, 0);
        writeNumericArg(view, _i6, _o5, a1, 1);
        writeNumericArg(view, _i7, _o6, a2, 2);
  ...
  if (nargs === 5) {
    ...
    var _i1 = argInfos[3];
    var i4 = argInfos[4];
    var _o7 = argOffsets[0];
    var _o8 = argOffsets[1];
    var _o9 = argOffsets[2];
    var _o0 = argOffsets[3];
    var o4 = argOffsets[4];
    if (retGetter === null) {
      return function (a0, a1, a2, a3, a4) {
        ...
        writeNumericArg(view, _i8, _o7, a0, 0);
        writeNumericArg(view, _i9, _o8, a1, 1);
        writeNumericArg(view, _i0, _o9, a2, 2);
        writeNumericArg(view, _i1, _o0, a3, 3);
  ...
  if (nargs === 6) {
    ...
    var _i14 = argInfos[4];
    var i5 = argInfos[5];
    var _o1 = argOffsets[0];
    var _o10 = argOffsets[1];
    var _o11 = argOffsets[2];
    var _o12 = argOffsets[3];
    var _o13 = argOffsets[4];
    var o5 = argOffsets[5];
    if (retGetter === null) {
      return function (a0, a1, a2, a3, a4, a5) {
        ...
        writeNumericArg(view, _i10, _o1, a0, 0);
        writeNumericArg(view, _i11, _o10, a1, 1);
        writeNumericArg(view, _i12, _o11, a2, 2);
        writeNumericArg(view, _i13, _o12, a3, 3);
        writeNumericArg(view, _i14, _o13, a4, 4);
  ...
  if (retGetter === null) {
    return function () {
      if (arguments.length !== nargs) {
        throwFFIArgCountError(nargs, arguments.length);
      }
      for (var i = 0; i < nargs; i++) {
        writeNumericArg(view, argInfos[i], argOffsets[i], i < 0 || arguments.length <= i ? undefined : arguments[i], i);
      }
      rawFn();
    };
  }
...
var rawGetFunction = DynamicLibrary.prototype.getFunction;
var rawGetFunctions = DynamicLibrary.prototype.getFunctions;
DynamicLibrary.prototype.getFunction = function getFunction(name, signature) {
  ...
  var raw = FunctionPrototypeCall(rawGetFunction, this, name, signature);
...
DynamicLibrary.prototype.getFunctions = function getFunctions(definitions) {
  ...
  var raw = definitions === undefined ? FunctionPrototypeCall(rawGetFunctions, this) : FunctionPrototypeCall(rawGetFunctions, this, definitions);
  if (raw === undefined || raw === null) return raw;
  var keys = ObjectKeys(raw);
  var out = {
    __proto__: null
  };
...
};
{
  ...
  var functionsDescriptor = ObjectGetOwnPropertyDescriptor(DynamicLibrary.prototype, 'functions');
  var origGetter = functionsDescriptor?.get;
  ...
  assert(origGetter !== undefined, 'FFI: DynamicLibrary.prototype.functions accessor not found or has no getter');
  ObjectDefineProperty(DynamicLibrary.prototype, 'functions', {
    __proto__: null,
    configurable: true,
    enumerable: functionsDescriptor.enumerable,
    get() {
      var raw = FunctionPrototypeCall(origGetter, this);
      if (raw === undefined || raw === null) return raw;
      var wrapped = {
        __proto__: null
      };
