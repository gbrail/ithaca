...
function commonPrefix(strings) {
  ...
  var sorted = ArrayPrototypeToSorted(strings);
  var min = sorted[0];
...
function reverseString(line) {
  var from = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '\r';
  var to = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '\r';
  var parts = StringPrototypeSplit(line, from);
