...
if (credentials.implementsPosixCredentials) {
  var wrapped = wrapPosixCredentialSetters(credentials);
...
function wrapPosixCredentialSetters(credentials) {
  ...
  function initgroups(user, extraGroup) {
    ...
    var result = _initgroups(user, extraGroup);
    if (result === 1) {
...
function wrappedCwd() {
  if (cachedCwd === '') cachedCwd = rawMethods.cwd();
  return cachedCwd;
}
