...
public class Constants {
  ...
  /**
   * Iterate over the public fields of a class and set them as properties on the target object. This
   * automates the process of importing large numbers of constants to JavaScript.
   */
  public static void populate(Context cx, VarScope s, Scriptable target, Class<?> clazz) {
    populate(cx, s, target, clazz, null);
  }

  public static void populate(
      Context cx, VarScope s, Scriptable target, Class<?> clazz, String prefix) {
    for (Field field : clazz.getDeclaredFields()) {
      if (Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
        try {
          Object value = field.get(null);
          var name = prefix == null ? field.getName() : prefix + field.getName();
